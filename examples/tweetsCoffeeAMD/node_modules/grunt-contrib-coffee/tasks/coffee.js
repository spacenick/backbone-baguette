...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('coffee', 'Compile CoffeeScript files into JavaScript', function() {
    ...
    this.files.forEach(function(file) {
      ...
      srcFiles.forEach(function(srcFile) {
        ...
        srcCompiled = grunt.file.read(srcFile);
      ...
      if (taskOutput.length > 0) {
        var joinedTasks = taskOutput.join('\n');
        // Modification
        var result = compileCoffeeSrc(joinedTasks,options);
  ...
  var compileCoffeeSrc = function(srcCode, options) {

    try {
      return require('coffee-script').compile(srcCode);
    } catch (e) {
      grunt.log.error(e);
      grunt.fail.warn('CoffeeScript failed to compile.');
    }
